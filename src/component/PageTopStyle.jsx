...
const PageTopStyle = ({ children }) => {
    return (
        <div>
            <div className='relative bg-[#818eff25] h-12 md:h-42 lg:h-64 grid items-center text-center'>
                ...
                <img className='absolute -top-16 right-0' src="https://i.ibb.co/zbSjDv3/Vector-1.png" alt="logo image" />
